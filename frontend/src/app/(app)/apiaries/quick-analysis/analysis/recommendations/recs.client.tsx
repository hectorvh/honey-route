// frontend/src/app/(app)/apiaries/quick-analysis/analysis/recommendations/recs.client.tsx
'use client';
...
export default function RecommendationsPage() {
  ...
  const save = async () => {
    ...
    router.replace(`/apiaries/quick-analysis/analysis/result${location.search}`);
  };
