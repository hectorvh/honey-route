//frontend/src/app/(app)/apiaries/quick-analysis/analysis/capture/CaptureClient.tsx
'use client';
...
export default function CaptureClient() {
  ...
  function saveToQuickAnalysis() {
    if (!shotURL) return;
    try {
      const dataURL =
        (typeof window !== 'undefined' && sessionStorage.getItem('lastCaptureDataURL')) || shotURL;
      const payload = { images: [dataURL], video: null as string | null };
  ...
  function openUploadScreen() {
    router.push('/apiaries/quick-analysis/upload');
  }
